            ...
            sites.
                    ...
                    flatMapToPair(kv -> {
                        ...
                        while (iter.hasNext()) {
                            ...
                            contribs.add(new Tuple2<>(target, currenRank/ (double) edges.getNEdges()));
                        }
                        return contribs;
                    });
        return newRanks.reduceByKey(Double::sum).mapValues(v -> 0.15 + 0.85 * v);
    }
}
